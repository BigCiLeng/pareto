...
class EffectFun():
    ...
    def __init__(self):
        self.r_tatal_base=0.192
        self.bales_level_base=7.2
        self.diameter_base=6.51
        self.displacement_base=7200
        self.gms_base=1.096

        self.r_tatal_base=self.r_tatal_base/self.displacement_base
